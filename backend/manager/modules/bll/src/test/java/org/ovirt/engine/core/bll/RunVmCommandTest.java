...
public class RunVmCommandTest {
    ...
    @Rule
    public CpuFlagsManagerHandlerRule cpuFlagsManagerHandlerRule = new  CpuFlagsManagerHandlerRule();
    ...
    @Mock
    private Map<Version, CpuFlagsManagerHandler.CpuFlagsManager> managerDictionary;

    @Mock
    private CpuFlagsManagerHandler.CpuFlagsManager cpuFlagsManager;
    ...
    private void updateCpuFlagsManagerHandler() {
        when(cpuFlagsManager.GetVDSVerbDataByCpuName(Mockito.anyString())).thenReturn(CPU_ID);
        when(managerDictionary.get(Mockito.any(Version.class))).thenReturn(cpuFlagsManager);
        cpuFlagsManagerHandlerRule.updateManagerDictionary(managerDictionary);
    }
