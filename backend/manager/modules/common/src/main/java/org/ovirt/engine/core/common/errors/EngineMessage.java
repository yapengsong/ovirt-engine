...
public enum EngineMessage {
    ...
    USE_BASE_VERSION,
    USE_BASE_VERSION_CPU,
    USE_BASE_VERSION_CPU_HOTPLUG,
    USE_BASE_VERSION_MEM,
    USE_BASE_VERSION_HOST,
    USE_BASE_VERSION_HOSTDEV,

    USE_HIGHER_VERSION_CPU,
    USE_HIGHER_VERSION_MEM,
    USE_HIGHER_VERSION_HOST,
    ...
    ACTION_TYPE_FAILED_ONLY_ONE_GRAPHICS_SUPPORTED_IN_THIS_CLUSTER_LEVEL(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_PROFILE_ALREADY_EXISTS(ErrorType.BAD_PARAMETERS),
    ACTION_TYPE_FAILED_PROFILE_NOT_EXIST(ErrorType.BAD_PARAMETERS),
    ...
    VALIDATION_VDS_GROUP_NAME_NOT_NULL(ErrorType.BAD_PARAMETERS),
    VALIDATION_VDS_GROUP_NAME_MAX(ErrorType.BAD_PARAMETERS),
    VALIDATION_VDS_GROUP_NAME_INVALID(ErrorType.BAD_PARAMETERS),
    VALIDATION_VDS_GROUP_MIGRATE_ON_ERROR_NOT_NULL(ErrorType.BAD_PARAMETERS),
    VALIDATION_VDS_GROUP_SPICE_PROXY_HOSTNAME_OR_IP(ErrorType.BAD_PARAMETERS),
    ...
    NETWORK_ATTACHMENT_NETWORK_ID_IS_NOT_SET(ErrorType.BAD_PARAMETERS),
    NETWORK_ATTACHMENTS_NOT_EXISTS(ErrorType.BAD_PARAMETERS),
    ...
    NETWORK_ADDR_IN_STATIC_IP_BAD_FORMAT(ErrorType.BAD_PARAMETERS),
    NETWORK_ADDR_IN_GATEWAY_BAD_FORMAT(ErrorType.BAD_PARAMETERS),
    NETWORK_ADDR_IN_SUBNET_BAD_FORMAT(ErrorType.BAD_PARAMETERS),
    NETWORK_MAC_ADDRESS_IN_USE(ErrorType.CONFLICT),
    HOT_PLUG_UNPLUG_PASSTHROUGH_VNIC_NOT_SUPPORTED(ErrorType.NOT_SUPPORTED),
    ...
    NETWORK_BOND_RECORD_DOES_NOT_EXISTS(ErrorType.BAD_PARAMETERS),
    ...
    SINGLE_NETWORK_CANNOT_DETACH_NETWORK_USED_BY_VMS(ErrorType.CONFLICT),
    SINGLE_NETWORK_CANNOT_DETACH_NETWORK_USED_BY_SINGLE_VM(ErrorType.CONFLICT),
    MULTIPLE_NETWORKS_CANNOT_DETACH_NETWORKS_USED_BY_VMS(ErrorType.CONFLICT),
    MULTIPLE_NETWORKS_CANNOT_DETACH_NETWORKS_USED_BY_SINGLE_VM(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_PASSTHROUGH_PROFILE_NOT_SUPPORTED(ErrorType.NOT_SUPPORTED),
    ...
    ACTION_TYPE_FAILED_REFRESH_LUNS_UNSUPPORTED_ACTION(ErrorType.NOT_SUPPORTED),
    ...
    ACTION_TYPE_FAILED_SCSI_RESERVATION_NOT_VALID_FOR_FLOATING_DISK(ErrorType.CONFLICT),
    ...
    ACTION_TYPE_FAILED_MIGRATION_OF_PASSTHROUGH_VNICS_IS_NOT_SUPPORTED(ErrorType.NOT_SUPPORTED),
    ...
    VDS_GROUP_HOSTS_MUST_BE_DOWN(ErrorType.CONFLICT),
    ...
    VDS_GROUP_CPU_TYPE_CANNOT_BE_NULL(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_WRONG_PROTOCOL_FOR_CLUSTER_VERSION(ErrorType.INCOMPATIBLE_VERSION),
    ...
    NOT_SUPPORTED_PROTOCOL_FOR_CLUSTER_VERSION(ErrorType.BAD_PARAMETERS),
    ...
    VALIDATION_GLUSTER_VOLUME_BRICK_SERVER_ID(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_NO_CPU_PROFILE_WITH_THAT_ID(ErrorType.BAD_PARAMETERS),
    ...
    ACTION_TYPE_FAILED_AFFINITY_GROUP_CONTENT_REPETITION(ErrorType.CONSTRAINT_VIOLATION), // affinity 策略内容重复，拒绝创建
    ...
    LIBVIRT_SECRET_USAGE_NAME_CANNOT_BE_EMPTY(ErrorType.BAD_PARAMETERS),
    LIBVIRT_SECRET_USAGE_NAME_ALREADY_EXISTS(ErrorType.CONFLICT),
    ...
    FOREMAN_ENGINE_NOT_REGISTERED(ErrorType.NOT_SUPPORTED),
    FOREMAN_VM_NOT_REGISTERED(ErrorType.NOT_SUPPORTED),
    FOREMAN_HOST_NOT_REGISTERED(ErrorType.NOT_SUPPORTED),
    ...
    CLUSTER_WARN_VM_DUE_TO_UNSUPPORTED_MEMORY_RESTORE,
