...
select fn_db_add_config_value('HostDevicePassthroughSupported','false','3.0');
select fn_db_add_config_value('HostDevicePassthroughSupported','false','3.1');
select fn_db_add_config_value('HostDevicePassthroughSupported','false','3.2');
select fn_db_add_config_value('HostDevicePassthroughSupported','false','3.3');
select fn_db_add_config_value('HostDevicePassthroughSupported','false','3.4');
