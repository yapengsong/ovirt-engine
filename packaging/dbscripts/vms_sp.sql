...
BEGIN
      ...
      session = v_session,
      kvm_enable = v_kvm_enable,boot_sequence = v_boot_sequence,
...
BEGIN
      ...
      num_of_sockets = v_num_of_sockets,cpu_per_socket = v_cpu_per_socket,threads_per_cpu = v_threads_per_cpu,
