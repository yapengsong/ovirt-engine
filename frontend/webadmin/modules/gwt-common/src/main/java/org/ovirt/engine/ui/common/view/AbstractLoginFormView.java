...
public abstract class AbstractLoginFormView extends AbstractView {
    ...
    @UiField
    @WithElementId
    public PatternflyUiCommandButton userRoleButton;
    ...
    @UiField
    @WithElementId
    public PatternflyUiCommandButton adminRoleButton;
    ...
    public HasUiCommandClickHandlers getUserRoleButton() {
        return userRoleButton;
    }

    public HasUiCommandClickHandlers getAdminRoleButton() {
