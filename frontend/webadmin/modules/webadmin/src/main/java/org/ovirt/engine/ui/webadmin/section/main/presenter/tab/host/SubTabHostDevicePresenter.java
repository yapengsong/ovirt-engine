...
public class SubTabHostDevicePresenter extends AbstractSubTabPresenter<VDS, HostListModel, HostDeviceListModel,
        SubTabHostDevicePresenter.ViewDef, SubTabHostDevicePresenter.ProxyDef> {
    ...
    static TabData getTabData(
        ...
        return new ModelBoundTabData(constants.hostDeviceSubTabLabel(), 3, modelProvider);
    }

    @Inject
    public SubTabHostDevicePresenter(EventBus eventBus, ViewDef view, ProxyDef proxy, PlaceManager placeManager,
                                     SearchableDetailModelProvider<HostDeviceView, HostListModel, HostDeviceListModel> modelProvider) {
        super(eventBus, view, proxy, placeManager, modelProvider, HostSubTabPanelPresenter.TYPE_SetTabContent);
    }
