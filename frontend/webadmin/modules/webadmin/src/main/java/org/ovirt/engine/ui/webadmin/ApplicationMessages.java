...
public interface ApplicationMessages extends CommonApplicationMessages {
    ...
    @DefaultMessage("For Severe Server Load - Allow scheduling of {0}% of physical memory")
    String clusterPopupMemoryOptimizationForServerLabel(String a);

    @DefaultMessage("For Mild Server Load - Allow scheduling of {0}% of physical memory")
    ...
    @DefaultMessage("This Browser version isn''t optimal for displaying the application graphics (refer to <a class=\"ovirt-documentation-link\" href=\"{0}\">Documentation</a> for details)")
