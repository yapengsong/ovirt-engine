...
public class VmHostDeviceListModel extends HostDeviceListModelBase {
    ...
    private boolean selectionContainsPlaceholderDevices() {
        if (getSelectedItems() != null) {
            for (HostDeviceView hostDeviceView : (List<HostDeviceView>)getSelectedItems()) {
    ...
    private void onSave() {
        ...
        if (getEntity().getDedicatedVmForVds() == null || getEntity().getDedicatedVmForVds().equals(Guid.Empty)
    ...
    private void doAttachDevices(Collection<EntityModel<HostDeviceView>> items) {
        List<String> deviceNamesToAttach = new ArrayList<String>();
    ...
    private ArrayList<String> getSelectedDeviceNames() {
        ...
        for (HostDevice vmHostDevice : (List<HostDeviceView>)getSelectedItems()) {
