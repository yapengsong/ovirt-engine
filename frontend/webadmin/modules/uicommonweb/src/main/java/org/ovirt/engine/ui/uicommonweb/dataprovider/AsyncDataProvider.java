...
public final class AsyncDataProvider {
    ...
    public static void getAAAProfilesList(AsyncQuery aQuery) {
        convertAAAProfilesResult(aQuery, true);
        Frontend.getInstance().runQuery(VdcQueryType.GetAAAProfileList, new VdcQueryParametersBase(), aQuery);
    }

    public static void getAAAProfilesListViaPublic(AsyncQuery aQuery, boolean passwordBasedOnly) {
    ...
    public static void getVmChangedFieldsForNextRun(VM original, VM updated, VmManagementParametersBase updateVmParameters, AsyncQuery aQuery) {
    ...
    public static void getHostNumaTopologyByHostId(AsyncQuery asyncQuery, Guid hostId) {
    ...
    public static void getVMsWithVNumaNodesByClusterId(AsyncQuery asyncQuery, Guid clusterId) {
        asyncQuery.converterCallback = new IAsyncConverter() {
