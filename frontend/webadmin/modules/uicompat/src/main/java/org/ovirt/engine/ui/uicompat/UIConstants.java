...
public interface UIConstants extends com.google.gwt.i18n.client.Constants {
    ...
    @DefaultStringValue("Note that without a Guest Agent the data on the created snapshot may be inconsistent.")
    ...
    @DefaultStringValue("Qcow2 disks cannot be activated or deactivated.")
    String displayExtendDiskLimitDialog();
